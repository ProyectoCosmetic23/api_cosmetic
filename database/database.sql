CREATE DATABASE rest_api_cosmetic
...
VALUES (2, 1, 1, NOW(), NOW() + interval '7 days', 1001, 'Tarjeta de crédito', 1, 10, 15.00);

INSERT INTO ventas (id_Pedido, id_Cliente, id_Empleado, numero_Factura, fecha_Venta, estado_Venta, tipo_Pago, total_Venta)
VALUES (2, 1, 1, 1001, NOW(), 'Completada', 'Tarjeta de crédito', 200.00);
...
INSERT INTO comisiones (id_Empleado, id_Venta, total_Ventas, fecha_Comision, porcentaje_Comision, total_Comision, observacion_Comision)
VALUES (1, 1, 200.00, NOW(), 10, 20.00, 'Comisión para empleado 1');/* Se crea la tabla Roles */
CREATE TABLE roles (
	id_Rol INT GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
	nombre_Rol VARCHAR (100) NOT NULL UNIQUE,
	estado_Rol CHARACTER VARYING(15) NOT NULL,
...
INSERT INTO comisiones (id_Empleado, id_Venta, total_Ventas, fecha_Comision, porcentaje_Comision, total_Comision, observacion_Comision)
VALUES (1, 1, 200.00, NOW(), 10, 20.00, 'Comisión para empleado 1');